...
(def family-data
  {:nodes [{:id 0   :first-name "André"           :last-name "Troncy"    :generation 1 :sex "male"   :blood-line true  :birth 1859 :death 1931}
           ...
           {:id 31  :first-name "Jaques"          :last-name "Troncy"    :generation 3 :sex "male"   :blood-line true  :birth 1939}
           {:id 32  :first-name "Françoise"       :last-name "Bonhour"   :generation 3 :sex "female" :blood-line false :birth 1939}
           {:id 33  :first-name "Bernard"         :last-name "Troncy"    :generation 3 :sex "male"   :blood-line true  :birth 1940 :death 1992}
           {:id 34  :first-name "Marie-France"    :last-name "Troncy"    :generation 3 :sex "female" :blood-line true  :birth 1940}
           {:id 35  :first-name "Alain"           :last-name "Bertin"    :generation 4 :sex "male"   :blood-line true  :birth 1940}
           {:id 36  :first-name "Françoise"       :last-name "Jullien"   :generation 4 :sex "female" :blood-line false :birth 1941}
           {:id 37  :first-name "Philippe"        :last-name "Bonin"     :generation 4 :sex "male"   :blood-line false :birth 1941}
           {:id 38  :first-name "Jean-François"   :last-name "Troncy"    :generation 3 :sex "male"   :blood-line true  :birth 1942 :death 1994}
           {:id 39  :first-name "Danielle"        :last-name "Bertin"    :generation 4 :sex "female" :blood-line true  :birth 1943}
           {:id 40  :first-name "Didier"          :last-name "Goudot"    :generation 4 :sex "male"   :blood-line false :birth 1943}
   ...
   :links [{:source 1   :target 0   :relation :partner}
           ...
           {:source 31  :target 11  :relation :child}
           {:source 31  :target 12  :relation :child}
           {:source 33  :target 11  :relation :child}
           {:source 33  :target 12  :relation :child}
           {:source 33  :target 32  :relation :partner}
           {:source 34  :target 6   :relation :child}
           {:source 34  :target 10  :relation :child}
           {:source 35  :target 14  :relation :child}
           {:source 35  :target 16  :relation :child}
           {:source 36  :target 35  :relation :partner}
           {:source 38  :target 11  :relation :child}
           {:source 38  :target 12  :relation :child}
           {:source 39  :target 14  :relation :child}
           {:source 39  :target 16  :relation :child}
           {:source 39  :target 37  :relation :partner}
           {:source 41  :target 34  :relation :partner}
           {:source 42  :target 11  :relation :child}
           {:source 42  :target 12  :relation :child}
           {:source 43  :target 18  :relation :child}
